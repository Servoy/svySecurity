 ...
 * @param chart
 *
 * @properties={typeid:24,uuid:"76919A3E-69E4-4E20-A8CC-EFCCAAC41199"}
 */
function createChartTenantsWithMostUsers(chart){
    ...
    var data = {
        ...
        datasets: [{
           ...
           backgroundColor: getColors(ds.getMaxRowIndex())
            }]
        }
    };
 ...
 * @param chart
 *
 * @properties={typeid:24,uuid:"E53207BD-E7DA-4582-ABBD-8A368F947D40"}
 */
